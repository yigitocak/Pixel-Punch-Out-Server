...
auth.post('/signup', async (req, res) => {
    ...
    try {
        ...
        const verificationCode = sendEmail(email); // Send email and get verification code
...
auth.post("/login", async (req, res) => {
    ...
    try {
        ...
        if (pendingUser) {
            ...
            const newVerificationCode = sendEmail(email);
            ...
            return res.status(200).json({
                success: true,
                message: 'A new verification code has been sent to your email. Please verify your account.'
            });
        }
