...
/*
-----------------------------------------------------------------
-                   USERNAME RELATED VIEWS                      -
-----------------------------------------------------------------
 */

export async function ChangeUsernameView(req, res) {
...
// PROFILE DELETE VIEW
export async function DeleteProfileView(req, res) {
...
// VIEW TO INCREMENT WINS
export async function IncrementWinsView(req, res) {
  const { username } = req.params;
...
// VIEW TO INCREMENT LOSSES
export async function IncrementLossesView(req, res) {
  const { username } = req.params;
  const { secret } = req.body;
...
export async function FetchAllUsersView(req, res) {
  try {
...
// VIEW TO CHANGING PROFILE PHOTO
export async function UploadPhotoView(req, res) {
  const { username } = req.params;
...
// VIEW TO MAKE COMMENTS
export async function AddCommentView(req, res) {
  const { username } = req.params;
...
export async function DeleteCommentView(req, res) {
